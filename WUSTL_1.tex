...
\institute[Stanford University]{Associate Professor\\Department of Political Science \\ University of Chicago}
\vspace{0.3in}


\date{August 15th, 2017}%[Big Data Workshop]
%\date{\today}
...
\item[] Week 1:
\begin{itemize}
\item[1)] 8/15: Acquiring, preprocessing, and comparing text
\item[2)] 8/16: \textbf{Discovery}: Vector Space Model of Text, Clustering Methods, Separating Words
\item[3)] 8/17: \textbf{Measurement}: Dictonary Methods, Hand Coding, Supervised Methods Part 1
\end{itemize}
\item[] Week 2:

\begin{itemize}
\item[4)] 8/22: \textbf{Measurement}: Supervsed Methods Part 2
\item[5)] 8/23: \textbf{Measurement}: Topic Models
\item[6)] 8/24: \textbf{Causal Inference}: Train/Test Split, Analyst Induced SUTVA, Text as Dependent and Independent
\end{itemize}
\end{itemize}
